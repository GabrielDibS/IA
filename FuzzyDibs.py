...
umidade['muito baixa'] = fuzz.trapmf(umidade.universe, [0, 0, 20, 30])
...
umidade['muito alta'] = fuzz.trapmf(umidade.universe, [75, 85, 100, 100])
umidade.view()

precipitacao['muito baixa'] = fuzz.trapmf(precipitacao.universe, [0, 0, 2, 3])
...
precipitacao['muito alta'] = fuzz.trapmf(precipitacao.universe, [12, 14, 100, 100])
precipitacao.view()

VFR['alto negativo'] = fuzz.trapmf(VFR.universe, [-40, -40, -35, -20])
...
VFR['alto positivo'] = fuzz.trapmf(VFR.universe, [5, 7, 100, 100])
VFR.view()
...
risco_queimadas.input['Precipitacao(mm)'] = 6
